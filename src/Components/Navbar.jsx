...
import { Home, Hospital, LucideMenu, User2 } from "lucide-react";
...
function Navbar() {
  ...
  const Dex_menu =
    "flex md:text-[12px] gap-1.5 cursor-pointer whitespace-nowrap hover:text-amber-500 font-black p-2 rounded-[10px] ";
  ...
  return (
    <>
          ...
          <ul className="md:flex md:flex-nowrap xl:gap-2 md:gap-2 hidden ">
            <li className={Dex_menu}>
              <NavLink
                to="/"
                className={({ isActive }) =>
                  `${isActive ? "text-blue-500 border-b-blue-400 border-b-2 font-black flex gap-1.5 " : " flex gap-1.5 font-black"}`
                }>
                {" "}
                <Home size={18} />
                HOME
            ...
            <li className={Dex_menu}>
              <NavLink
                to="doctor"
                className={({ isActive }) =>
                  `${isActive ? "text-blue-500 border-b-blue-400  font-black flex gap-1.5 " : " flex gap-1.5 font-black"}`
                }>
                <Hospital size={18} />
                DOCTOR
              </NavLink>
          ...
          <div className="flex  justify-between items-center gap-5  ">
            ...
            <button
              ...
              className={`  text-sm flex justify-center items-center font-bold px-4 not-md:py-4 py-1.5 rounded-[10px] not-md:h-7 hover:px-8 transition-all duration-300 ${
                clicked
                  ? "border-red-600 border shadow-2xl bg-red-600/30 shadow-red-600 "
                  : " border-green-400 border hover:bg-green-500/20 text-green-500 shadow-2xl shadow-green-600"
              }`}>
              {clicked ? (
                "LogOut"
              ) : (
            ...
            <button
              ...
              {/* <h1>MENU</h1> */}
              <LucideMenu
                className={open ? "text-lime-400" : "text-amber-500"}
              />
              <h1>Menu</h1>
            </button>
          </div>
      ...
      {open && (
        <div
          ref={RefMenuBar}
          className="w-50 flex fixed right-2 top-10 mt-2 z-40 transition-all duration-1000 "
          ...
          <ul
            ...
            <li>
              ...
              <NavLink
                to="/"
                className={({ isActive }) =>
                  `${menuclass} flex gap-2 items-center  ${
                    isActive
            ...
            <li>
              ...
              <NavLink
                to="Academic"
                className={({ isActive }) =>
                  `${menuclass} flex gap-3 items-center ${
                    isActive
                      ? "text-zinc-100 border border-zinc-400/40 backdrop-blur-md italic rounded-xl px-4 py-2 bg-zinc-900/40 transition-all duration-500 shadow-lg shadow-zinc-950/20 hover:border-zinc-300 hover:bg-zinc-900/60"
                      : "text-zinc-500/80 border border-zinc-500/10 backdrop-blur-sm italic rounded-xl px-4 py-2 bg-white/5 transition-all duration-500 hover:text-zinc-400 hover:border-zinc-500/30 hover:bg-white/10"
                  }`
